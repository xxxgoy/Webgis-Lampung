            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Daerah Rawan</h1>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal style-form" style="margin-top: 10px;" action="tambah_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="nama_daerah" type="text" class="form-control" placeholder="Nama Daerah" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-4 control-label">Penyebab</label>
                                    <div class="col-sm-6">
                                        <input name="penyebab" class="form-control" type="text" placeholder="Penyebab" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-4 control-label">Mitigasi</label>
                                    <div class="col-sm-6">
                                        <input name="mitigasi" class="form-control" type="text" placeholder="Mitigasi" required />
                                    </div>
                                </div>
