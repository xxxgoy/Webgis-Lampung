...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>SIG MITIGASI BANJIR</title>

	<link rel="icon" href="admin/img/lampung.png">
	...
	<header id="header">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="admin/img/lampung.png" width="40px" height="50px" alt="lampung" title="" /></a>
					<a href="index.php"><img src="admin/img/itera.png" width="50px" height="50px" alt="logo_itera" title="" /></a>
				</div>
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						<li><a href="index.php">Home</a></li>
						<li><a href="peta_interaktif.php">Peta Interaktif</a></li>
